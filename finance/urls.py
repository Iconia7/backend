...
from .views import GoalDetailView, GoalListCreateView, DepositView, OrderListView, PaymentCallbackView, RepayView, TransactionListView, ProductListView,OrderCreateView, UpdateFCMTokenView,VerifyPickupView
